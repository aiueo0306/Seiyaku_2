...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.kyosomirai-p.co.jp/medical/information/"
GAKKAI = "共創未来ファーマ（医療機関）"

SELECTOR_TITLE = "ul.news-list.is_medical li:not([class])"
title_selector = "div.news-list_title"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.news-list.is_medical li:not([class])"  # typo修正済み
date_selector = "div.news-list_date"
date_index = 0
year_unit = "."
month_unit = "."
day_unit = ""
