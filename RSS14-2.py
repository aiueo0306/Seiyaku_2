...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.med.kyorin-rmd.com/news/"
GAKKAI = "キョーリンリメディオ（医療機関）"

SELECTOR_TITLE = "ul#news-lists li.news-lists-item"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul#news-lists li.news-lists-item"  # typo修正済み
