...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.orphanpacific.com/medical/news/"
GAKKAI = "オーファンパシフィック(医療機関)"

SELECTOR_TITLE = "div#news article"
title_selector = "p.text"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div#news article"  # typo修正済み
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed4-2.xml"
