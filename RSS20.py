...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.santen.com/jp"
GAKKAI = "参天製薬（ニュース）"

SELECTOR_TITLE = "div.newslisting-headline__list div.newslisting-headline__item"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.newslisting-headline__list div.newslisting-headline__item"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "年"
month_unit = "月"
