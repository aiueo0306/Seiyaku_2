...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.santen.co.jp/medical-channel/di/information/"
GAKKAI = "参天製薬（医療機関）"

SELECTOR_TITLE = "div.c-tab__content.js-tabContent.is-active li.c-newsList__li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.c-tab__content.js-tabContent.is-active li.c-newsList__li"  # typo修正済み
date_selector = "span.c-newsList__date.u-width__5em.c-text__14"
date_index = 0
year_unit = "."
month_unit = ""
day_unit = ""
