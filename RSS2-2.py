...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.okayama-taiho.co.jp/medical/products/news/"
GAKKAI = "岡山大鵬(医療機関)"

SELECTOR_TITLE = "div.tab-content.tab_all.show div.news-content-flex"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.tab-content.tab_all.show div.news-content-flex"  # typo修正済み
