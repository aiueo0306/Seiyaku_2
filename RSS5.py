...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://viivhealthcare.com/ja-jp/news/"
GAKKAI = "ヴィーヴヘルスケア"

SELECTOR_TITLE = "ul.articleList-list li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.articleList-list li"
date_selector = "div.articleList-date"
date_index = 0
year_unit = "年 "
month_unit = "月 "
day_unit = "日"
...
POPUP_BUTTONS = ["すべてのCookieを受け入れる"]  # 必要に応じて編集
