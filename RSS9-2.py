...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://med.kissei.co.jp/information/"
GAKKAI = "キッセイ薬品(医療機関)"

SELECTOR_TITLE = "ul.info__content__item a"
title_selector = "em"
title_index = 0
href_selector = ""
href_index = 0
SELECTOR_DATE = "ul.info__content__item a"  # typo修正済み
date_selector = "span"
date_index = 0
year_unit = "年"
month_unit = "月"
...
POPUP_BUTTONS = ["薬剤師（保険薬局）","同意する"] if POPUP_MODE else [] 
