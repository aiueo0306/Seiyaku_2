...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.kaigen-pharma.co.jp/medical_products/news/"
GAKKAI = "カイゲンファーマ(医療機関)"

SELECTOR_TITLE = "ul.news-release-items.news-release-items--medical li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.news-release-items.news-release-items--medical li"  # typo修正済み
date_selector = "span.news-release-items__status__date"
date_index = 0
year_unit = "年"
month_unit = "月"
day_unit = "日"
