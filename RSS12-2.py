...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.kyorin-pharm.co.jp/prodinfo/hotnews/"
GAKKAI = "杏林製薬(医療機関)"

SELECTOR_TITLE = "ul.module-news-list li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.module-news-list li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "年"
month_unit = "月"
...
POPUP_BUTTONS = ["医療用医薬品の各種情報はこちら"] if POPUP_MODE else [] 
